        ...
        <!-- END THEME PANEL -->
            ...
            <div class="containers">
                <div class="col-md-12 form-group">
                    <br>
                    <button type="button" class="btn blue" data-toggle="modal" data-target="#partners">Create Invoice</button>
                </div>
                <div class="col-md-12">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="portlet box grace-blue form-outer-part">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption"><b>Add New Office</b></div>
                </div>
                ...
                <form action="{{route('offices.store')}}" method="POST" id="addPartner">
                    ...
                    <div class="portlet-body form-inner-part">
                        ...
                        <div align="center">
                            <input type="submit" class="btn blue button-submit btn-md" value="Save">

        ...
        <!-- END THEME PANEL -->
            ...
            <div class="containers">
                <div class=" col-md-12 form-group">
                    <br>
                    <button type="button" class="btn blue" data-toggle="modal" data-target="#partners">Add Partner</button>
                </div>
...
{{--                                <td>{{++$key}}</td>--}}
                                ...
                                <td>
                                    <!-- <div class="col-md-12"> -->
                                        <!-- <div class="col-md-6"> -->
                                            <a href="{{route('partners.edit',$university->id)}}" class="btn btn-default"><i class="fa fa-edit"></i></a>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-6"> -->
                                            <form action="{{route('partners.destroy',$university->id)}}" method="post">
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="portlet box grace-blue form-outer-part">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-edit"></i> Add New Partner </div>
                </div>
                <div class="portlet-body form-inner-part">
                    <form action="{{route('partners.store')}}" method="POST" id="addPartner">
                        {{csrf_field()}}
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category">
                                            ...
                                            <option value="College" {{(old('category')==='College') ? 'selected' : ''}}>College</option>
                                        </select>

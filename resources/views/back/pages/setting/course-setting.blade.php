        ...
        <!-- END THEME PANEL -->
            ...
            <div class="containers">
                ...
                <div class="table col-md-12">
                            ...
                            @foreach($courses as $key=>$course)
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-12">
                                            <div class="col-md-2">
                                                <button type="button" class="passingValue btn btn-default" data-toggle="modal" data-target="#course" data-id="{{$course->name}}"><i class="fa fa-edit"></i></button>
                                            </div>
                                            <div class="col-md-2">
                    ...
                    {{--Course Modal Start--}}
                    <div id="course" class="modal fade" role="basic" aria-hidden="true" tabindex="-1">
                        <div class="modal-dialog">
                            <!-- Modal content-->
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    <h3 class="modal-title"><b>Edit Course</b></h3>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="{{route('course.update','hiddenValue')}}" method="POST">
                                                {{method_field('PUT')}}
                                                {{csrf_field()}}
